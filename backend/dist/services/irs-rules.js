...
exports.IRS_TY_2024 = exports.IRS_TY_2026 = void 0;
exports.rulesForYear = rulesForYear;
exports.computeFedIncomeTax = computeFedIncomeTax;
exports.computeSsTax = computeSsTax;
exports.computeMedTax = computeMedTax;
exports.IRS_TY_2026 = {
...
function rulesForYear(taxYear) {
    if (taxYear >= 2026)
        return exports.IRS_TY_2026;
    if (taxYear >= 2024)
        return exports.IRS_TY_2024;
    return exports.IRS_TY_2024; // fallback for legacy years
}
/**
 ...
 */
function computeFedIncomeTax(taxableIncome, filingStatus, taxYear) {
    const rules = rulesForYear(taxYear);
    const brackets = filingStatus === 'married' ? rules.BRACKETS_MFJ
        : filingStatus === 'hoh' ? rules.BRACKETS_HOH ?? rules.BRACKETS_SINGLE
 ...
 */
function computeSsTax(annualGross, taxYear) {
    const rules = rulesForYear(taxYear);
 ...
 */
function computeMedTax(annualGross, taxYear) {
    const rules = rulesForYear(taxYear);
...
//# sourceMappingURL=irs-rules.js.map